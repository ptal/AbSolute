function readJson(json) {
  ...
  for (var j = 0; j < instances.length; j++){
	  ...
	  inner = inner + '<div id = "'+div_name+'">'+"Number of instances solved among "+nb_instances+	" over "+max_time+" secondes with prolem "+p_name+" and instance "+i_name+'<canvas id="'+chart_name+'"" width="1600" height="900"></canvas> </div>';
